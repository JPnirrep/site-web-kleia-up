...
- **v3.17.0-SEO-CRITICAL-FIX (10/06/2026)** : P2 corrections immédiates et consolidation SEO/GEO. 🔴 **CRITIQUE** : 4 balises `<title>` cassées (journal, contact, programmes, a-propos) — le `<link rel="icon">` était inclus dans le `<title>`, rendant les pages invisibles pour Google. 🟡 **Médias sociaux** : `og:image` + Twitter Cards ajoutés à `entreprises.html`. 🟡 **JSON-LD** : harmonisé sur tout le site (atelier-place, challenge-juin26, kit-survie avec @graph cohérent). 🌍 **GEO** : meta geo.region ajoutées à contact, atelier-place, challenge-juin26. 📄 **llms.txt** : enrichi avec 10 articles, FAQ, témoignages, entités détaillées. 🗺️ **Sitemap** : priorité offres/signature corrigée (0.7→0.3), tous les lastmod → 2026-06-10. ⚡ **Performance** : CSS critique inline + deferred stylesheet sur les 4 pages principales (index, programmes, entreprises, individuel-groupe) pour améliorer le FCP. 

- **v3.16.1-BLOG-10ARTICLES (08/06/2026)** : Lancement du blog KLEIA-UP. 10 articles publiés depuis les newsletters Brevo (croire en l'autre, masque social, rigologie, chaos/résilience, corps/prise de parole, frontières/limites, humain avant méthode, talent). Chaque article a sa propre page dans `journal/` avec Article schema JSON-LD, Breadcrumb 3 niveaux, OG/Twitter cards, header/footer complet. Page index `journal.html` avec grille de 10 cartes classées par date. 15 URLs indexables au total (4 pages de plus dans le sitemap). P0 : OG/Twitter cards 7 pages, hero image 209→60 KB, cache .htaccess assets 1 an. P1 : Logo WebP 113→21 KB, loading lazy, pages orphelines, sitemap enrichi. P2 : FAQPage 10 questions, Review schema 4 témoignages. Auto-correction : ajout classe CSS `.btn-subtle` manquante.
